 ...
 * 
 * Lorsque le server.model est MAJ, la méthode moveCapturePromotion() est invoquée pour
 * déplacer effectivement la piéce sur le damier et éventuellement prendre et/ou promouvoir une PieceGui
 * (invocation é partir du server.controller en passant par classe View)
 * 
 */
class Board extends GridPane {
	...
	/////////////////////////////////////////////////////////////
	// Actions sur la view
	// initiées par le server.controller en passant par la classe View
	/////////////////////////////////////////////////////////////


	/**
	 * @param dataToRefreshView
	 * Cette méthode est appelée par le server.controller en passant par la classe View
	 * afin de rafraichir la view lorsque le server.model a été mis é jour
	 */
