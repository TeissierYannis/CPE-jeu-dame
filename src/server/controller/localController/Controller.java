...
import server.controller.InputViewData;
import server.controller.Mediator;
import server.controller.OutputModelData;
import client.gui.CheckersSquareGui;
...
import server.model.ModelConfig;
 ...
 * <p>
 * Le server.controller a 2 responsabilités :
 * - il écoute les clics de souris de l'utilisateur sur la vue
 * - il invoque la méthode moveCapturePromote() du server.model
 * si actions (move + prise + promotion) OK sur server.model alors elles sont propagées sur view
 * (invoque méthode moveCapturePromote() de la view)
 * <p>
 * La view et le server.model ne gérant pas les coordonnées des cases de la méme maniére
 * le server.controller assure la conversion :
 * - index de 0 é 99 pour la view
 * - Coord (col, ligne) pour le server.model ['a'..'j'][10..1]
 */
public class Controller implements Mediator, BoardGame<Integer>, EventHandler<MouseEvent> {
    ...
    //////////////////////////////////////////////////////////////////
    //
    // Controller vu comme un médiateur entre la view et le server.model
    //
    //////////////////////////////////////////////////////////////////
    ...
    private void checkersSquareGuiHandle(MouseEvent mouseEvent) throws IOException {
        ...
        this.out.flush();
        // Le server.controller va invoquer la méthode moveCapturePromotion() du server.model
        // et si le server.model confirme que la piéce a bien été déplacée écet endroit,
    ...
    //////////////////////////////////////////////////////////////////
    //
    // Controller vu comme un Substitut du server.model
    // il invoque les méthodes du server.model
    // aprés actions de l'utilisateur sur la vue
    //
    //////////////////////////////////////////////////////////////////

    /**
     * Invoque méthode moveCapturePromote() du server.model (aprés transformation des coordonnées)
     * Si déplacement effectif sur server.model, invoque méthode actionOnGui() de la view
     * pour rafraichir affichage en fonction des données retournées par le server.model
     */
    @Override
    public OutputModelData<Integer> moveCapturePromote(Integer toMovePieceIndex, Integer targetSquareIndex) throws IOException {
        ...
        System.out.println("[CONTROLLER] output server.model data " + outputModelData);
